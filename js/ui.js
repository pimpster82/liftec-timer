...
class UI {
  ...
  getI18N() {
    return {
      de: {
        ...
        rateAdd: 'Neuer Satz',
        rateEdit: 'Satz bearbeiten',
        rateSaved: 'Satz gespeichert',
        rateDeleted: 'Satz gelöscht',
        rateMoney: 'Sätze',
        rateMoneyHint: '0 lassen, wenn nicht gepflegt – die Umrechnung wird dann ausgeblendet.',
        validFrom: 'Gültig ab',
        validFromHint: 'Ab diesem Tag gelten die Werte darunter.',
        validFromMissing: 'Bitte ein Gültig-ab-Datum angeben',
        onCallRate: 'Bereitschaft €/h',
        hourlyWage: 'Stundenlohn €',
        hourlyWageShort: 'Lohn',
        week: 'Woche',
        edit: 'Bearbeiten',
        surchargePercent: 'Zuschlag %',
        surchargeFromPercent: 'Zuschlag wird aus dem Prozentsatz berechnet',
        tasks: 'Aufgaben',
        ...
        calloutRecorded: 'Einsätze im gewählten Monat',
        ...
        barModeBalance: 'Saldo',
        timeAccountTrend: 'Zeitkonto',
        plusHours: 'Plus',
        minusHours: 'Minus',
        ...
        declineAllConfirm: '{count} Einträge ablehnen? Sie verschwinden damit aus dem Posteingang.',
        acceptAllSkipsConflicts: 'Tage, an denen schon ein Eintrag liegt, bleiben stehen und werden einzeln entschieden.',
        acceptAllDone: '{imported} übernommen, {skipped} offen',
        acceptAllDoneAll: '{imported} Einträge übernommen',
        dateAlreadyUsed: 'Für diesen Tag gibt es bereits einen Eintrag',
        ...
        noFriendsHint: 'Friends werden per QR-Code hinzugefügt - scanne einfach den Code des anderen.',
        recipient: 'Empfänger',
        loadFriendsFailed: 'Friends konnten nicht geladen werden',
        ...
        // Absence recording
        recordAbsence: 'Abwesenheit eintragen',
        absenceEntriesSaved: '{count} Abwesenheitseintrag/e gespeichert',
        chooseAbsenceType: 'Art wählen',
        ...
        adjustmentDescription: 'Geben Sie die Werte von Ihrem letzten Lohnzettel ein, um Zeitkonto und Urlaub abzugleichen.',
        payrollMonth: 'Monat des Lohnzettels',
        payrollMonthHelp: 'Wählen Sie den Monat aus, für den die Werte gelten',
        timeAccountFromPayroll: 'Zeitkonto laut Lohnzettel',
        vacationFromPayroll: 'Resturlaub laut Lohnzettel',
        vacationHelp: 'Verbleibende Urlaubstage aus Ihrem Lohnzettel',
        adjustmentSummary: 'Zusammenfassung',
        referenceDateLabel: 'Stichtag',
        calculationInfo: 'Alle Zeiten nach diesem Datum werden hinzugerechnet',
        ...
        hardRefresh: 'Daten neu laden (Cache leeren)',
        autoSyncInfo: 'Automatischer Sync: alle 60 Minuten',
        hardRefreshInfo: '"Daten neu laden" löscht den Cache und holt aktuelle Daten vom Cloud. Nutze dies beim Gerätewechsel.',
        signInAnonymous: 'Anonym anmelden',
        signInWithEmail: 'Mit Email anmelden',
        linkEmailToAccount: 'Account mit Email verbinden',
        signOut: 'Abmelden',
        syncAutoInfo: 'Deine Daten werden automatisch zwischen allen Geräten synchronisiert',
        syncSignInInfo: 'Melde dich an, um deine Daten zwischen Geräten zu synchronisieren',
        // App Updates
        appUpdates: 'App-Updates',
        currentVersion: 'Aktuelle Version:',
        availableVersion: 'Verfügbare Version:',
        checkForUpdates: 'Auf Updates prüfen',
        autoUpdateCheckInfo: 'Updates werden automatisch beim App-Start geprüft',
        versionManagement: 'Versionsverwaltung',
        loadingVersions: 'Lade verfügbare Versionen...',
        versionRestoreInfo: 'Stable Versions können wiederhergestellt werden. Alle Daten werden automatisch gesichert.',
        // Banner Messages
        ...
        // Sharing & Friends
        sharingAndFriends: 'Teilen & Freunde',
        myShareProfile: 'Mein Share-Profil',
        showMyQRCode: 'Mein QR-Code anzeigen',
        scanFriendQR: 'Friend QR scannen',
        manageFriends: 'Friends verwalten',
        sharingInfo: 'Erstelle ein Profil, teile deinen QR-Code und füge Friends hinzu um Zeiteinträge zu teilen',
        // Notes
        ...
        noNotesInCategory: 'Keine Notizen in dieser Kategorie',
        deleteNotesWarning: 'Alle Notizen in dieser Kategorie werden ebenfalls gelöscht. Diese Aktion kann nicht rückgängig gemacht werden.',
        newTextNote: 'Neue Text-Notiz',
      ...
      en: {
        ...
        rateMoney: 'Rates',
        rateMoneyHint: 'Leave at 0 if unused – the conversion is then hidden.',
        validFrom: 'Valid from',
        validFromHint: 'The values below apply from this day on.',
        validFromMissing: 'Please enter a valid-from date',
        onCallRate: 'On-call €/h',
        hourlyWage: 'Hourly wage €',
        hourlyWageShort: 'wage',
        week: 'week',
        edit: 'Edit',
        surchargePercent: 'Surcharge %',
        surchargeFromPercent: 'Surcharge is calculated from the percentage',
        tasks: 'Tasks',
        addTask: 'Add task',
        ...
        calloutRecorded: 'Callouts in selected month',
        ...
        barModeDays: 'Days',
        barModeHours: 'Hours',
        barModeBalance: 'Balance',
        timeAccountTrend: 'Time account',
        plusHours: 'Plus',
        minusHours: 'Minus',
        ...
        declineAllConfirm: 'Decline {count} entries? They will disappear from the inbox.',
        acceptAllSkipsConflicts: 'Days that already have an entry stay put and are decided individually.',
        acceptAllDone: '{imported} accepted, {skipped} pending',
        acceptAllDoneAll: '{imported} entries accepted',
        dateAlreadyUsed: 'There is already an entry for this day',
        acceptShare: 'Accept',
        ...
        noFriendsHint: 'Friends are added by QR code - just scan the other person\'s code.',
        recipient: 'Recipient',
        loadFriendsFailed: 'Could not load friends',
        canOnlyShareWithFriends: 'You can only share with friends',
        // Work Time Tracking & Vacation (ZA & Urlaub)
        workTimeTracking: 'Time Account & Vacation',
        workTimeTrackingShort: 'Time Compensation & Vacation (ZA)',
        enableWorkTimeTracking: 'Enable Time & Vacation',
        workTimeTrackingDesc: 'Manage your time account and vacation',
        timeAccount: 'Time Account (ZA)',
        vacation: 'Vacation',
        ...
        absenceEntriesSaved: '{count} absence entr(y/ies) saved',
        chooseAbsenceType: 'Choose type',
        ...
        adjustmentDescription: 'Enter the values from your last payslip to synchronize time account and vacation.',
        payrollMonth: 'Payroll Month',
        payrollMonthHelp: 'Select the month for which the values apply',
        timeAccountFromPayroll: 'Time account from payroll',
        vacationFromPayroll: 'Remaining vacation from payroll',
        vacationHelp: 'Remaining vacation days from your payroll',
        adjustmentSummary: 'Summary',
        referenceDateLabel: 'Reference Date',
        calculationInfo: 'All times after this date will be added',
        ...
        syncNow: 'Sync now',
        hardRefresh: 'Reload data (clear cache)',
        autoSyncInfo: 'Automatic sync: every 60 minutes',
        hardRefreshInfo: '"Reload data" clears the cache and fetches current data from the cloud. Use this when switching devices.',
        signInAnonymous: 'Sign in anonymously',
        signInWithEmail: 'Sign in with email',
        linkEmailToAccount: 'Link email to account',
        signOut: 'Sign out',
        syncAutoInfo: 'Your data is automatically synchronized across all devices',
        syncSignInInfo: 'Sign in to synchronize your data across devices',
        // App Updates
        appUpdates: 'App Updates',
        currentVersion: 'Current version:',
        availableVersion: 'Available version:',
        checkForUpdates: 'Check for updates',
        autoUpdateCheckInfo: 'Updates are checked automatically at app start',
        versionManagement: 'Version Management',
        loadingVersions: 'Loading available versions...',
        versionRestoreInfo: 'Stable versions can be restored. All data is automatically backed up.',
        // Banner Messages
        ...
        // Sharing & Friends
        sharingAndFriends: 'Sharing & Friends',
        myShareProfile: 'My Share Profile',
        showMyQRCode: 'Show my QR code',
        scanFriendQR: 'Scan friend QR',
        manageFriends: 'Manage friends',
        sharingInfo: 'Create a profile, share your QR code and add friends to share time entries',
        // Notes
        myNotes: 'My Notes',
        category: 'Category',
        manage: 'Manage',
        ...
        deleteNotesWarning: 'All notes in this category will also be deleted. This action cannot be undone.',
      ...
      hr: {
        ...
        rateAdd: 'Nova stopa',
        rateEdit: 'Uredi stopu',
        rateSaved: 'Stopa spremljena',
        rateDeleted: 'Stopa obrisana',
        rateMoney: 'Stope',
        rateMoneyHint: 'Ostavi 0 ako se ne koristi – preračun se tada ne prikazuje.',
        validFrom: 'Vrijedi od',
        validFromHint: 'Vrijednosti ispod vrijede od ovog dana.',
        validFromMissing: 'Molimo unesite datum od kada vrijedi',
        onCallRate: 'Dežurstvo €/h',
        hourlyWage: 'Satnica €',
        hourlyWageShort: 'satnica',
        week: 'tjedan',
        edit: 'Uredi',
        surchargePercent: 'Prirez %',
        surchargeFromPercent: 'Prirez se računa iz postotka',
        tasks: 'Zadaci',
        ...
        calloutRecorded: 'Intervencije u odabranom mjesecu',
        ...
        weekShort: 'TJ',
        untilToday: 'do danas',
        stillOpen: 'još otvoreno',
        statsNoData: 'Još nema podataka za analizu',
        barModeDays: 'Dani',
        barModeHours: 'Sati',
        barModeBalance: 'Saldo',
        timeAccountTrend: 'Račun vremena',
        plusHours: 'Plus',
        minusHours: 'Minus',
        ...
        declineAllConfirm: 'Odbiti {count} unosa? Nestat će iz pristigle pošte.',
        acceptAllSkipsConflicts: 'Dani koji već imaju unos ostaju i odlučuju se pojedinačno.',
        acceptAllDone: '{imported} preuzeto, {skipped} otvoreno',
        acceptAllDoneAll: '{imported} unosa preuzeto',
        dateAlreadyUsed: 'Za ovaj dan već postoji unos',
        ...
        noFriendsHint: 'Prijatelji se dodaju QR kodom - jednostavno skeniraj kod druge osobe.',
        recipient: 'Primatelj',
        loadFriendsFailed: 'Prijatelji se nisu mogli učitati',
        canOnlyShareWithFriends: 'Možeš dijeliti samo s prijateljima',
        // Work Time Tracking & Vacation (ZA & Urlaub)
        workTimeTracking: 'Radni sat i godišnji odmor',
        workTimeTrackingShort: 'Radni sat & Odmor (ZA)',
        ...
        timeAccount: 'Račun radnih sati (ZA)',
        ...
        // Absence recording
        recordAbsence: 'Zabilježi odsutnost',
        absenceEntriesSaved: '{count} unos/a odsutnosti spremljeno',
        chooseAbsenceType: 'Odaberi vrstu',
        absenceType: 'Vrsta odsutnosti',
        monday: 'Ponedjeljak',
        tuesday: 'Utorak',
        wednesday: 'Srijeda',
        thursday: 'Četvrtak',
        ...
        adjustmentDescription: 'Unesite vrijednosti s posljednje platne liste kako biste uskladili račun radnih sati i godišnji odmor.',
        payrollMonth: 'Mjesec platne liste',
        payrollMonthHelp: 'Odaberite mjesec za koji vrijednosti vrijede',
        timeAccountFromPayroll: 'Račun radnih sati prema platnoj listi',
        vacationFromPayroll: 'Preostali odmor prema platnoj listi',
        vacationHelp: 'Preostali dani godišnjeg odmora iz vaše platne liste',
        adjustmentSummary: 'Sažetak',
        referenceDateLabel: 'Referentni datum',
        calculationInfo: 'Sva vremena nakon ovog datuma bit će dodana',
        ...
        // Cloud Sync
        cloudSyncTitle: 'Sinkronizacija s oblakom',
        syncNow: 'Sinkroniziraj sada',
        hardRefresh: 'Ponovno učitaj podatke (očisti predmemoriju)',
        autoSyncInfo: 'Automatska sinkronizacija: svakih 60 minuta',
        hardRefreshInfo: '"Ponovno učitaj podatke" briše predmemoriju i dohvaća trenutne podatke iz oblaka. Koristi ovo pri promjeni uređaja.',
        signInAnonymous: 'Prijavi se anonimno',
        signInWithEmail: 'Prijavi se s emailom',
        linkEmailToAccount: 'Poveži email s računom',
        signOut: 'Odjavi se',
        syncAutoInfo: 'Tvoji podaci se automatski sinkroniziraju na svim uređajima',
        syncSignInInfo: 'Prijavi se za sinkronizaciju podataka na svim uređajima',
        // App Updates
        appUpdates: 'Ažuriranja aplikacije',
        currentVersion: 'Trenutna verzija:',
        availableVersion: 'Dostupna verzija:',
        checkForUpdates: 'Provjeri ažuriranja',
        autoUpdateCheckInfo: 'Ažuriranja se automatski provjeravaju pri pokretanju aplikacije',
        versionManagement: 'Upravljanje verzijama',
        loadingVersions: 'Učitavanje dostupnih verzija...',
        versionRestoreInfo: 'Stabilne verzije mogu biti vraćene. Svi podaci se automatski sigurnosno kopiraju.',
        // Banner Messages
        newVersionAvailable: 'Nova verzija dostupna',
        install: 'Instaliraj',
        moreInfo: 'Više informacija',
        skip: 'Preskoči',
        noDetailsAvailable: 'Nema dostupnih detalja',
        // Sharing & Friends
        sharingAndFriends: 'Dijeljenje i prijatelji',
        myShareProfile: 'Moj profil za dijeljenje',
        showMyQRCode: 'Prikaži moj QR kod',
        scanFriendQR: 'Skeniraj QR prijatelja',
        manageFriends: 'Upravljaj prijateljima',
        sharingInfo: 'Kreiraj profil, podijeli svoj QR kod i dodaj prijatelje za dijeljenje unosa vremena',
        // Notes
        myNotes: 'Moje bilješke',
        category: 'Kategorija',
        manage: 'Upravljaj',
        loadingNotes: 'Učitavanje bilješki...',
        textNote: 'Tekstualna bilješka',
        checklist: 'Popis zadataka',
        noNotesInCategory: 'Nema bilješki u ovoj kategoriji',
        deleteNotesWarning: 'Sve bilješke u ovoj kategoriji će također biti obrisane. Ovu radnju nije moguće poništiti.',
        newTextNote: 'Nova tekstualna bilješka',
        writeNote: 'Napiši bilješku...',
        noteCreated: 'Bilješka kreirana',
  ...
  icon(name, className = 'icon') {
    // Der uebergebene Klassenname ERSETZT die Vorgabe. Steht darin keine
    // Groesse, haette das SVG gar keine - der Browser malt es dann in seiner
    // Standardgroesse 300x150. Deshalb in dem Fall 'icon' davorsetzen.
    // Bewusst nur dann: neben 'w-5 h-5' wuerde '.icon' um die Groesse streiten.
    if (!/(^|\s)(icon|w-|h-)/.test(className)) {
    ...
    const icons = {
      ...
      'qr-code': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z"/></svg>',
      'camera': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9zM15 13a3 3 0 11-6 0 3 3 0 016 0z"/></svg>',
      'chevron-up': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"/></svg>',
      ...
      'info-circle': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',
      ...
      'heart': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>',
      'briefcase': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>',
      'refresh': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>',
      ...
      'arrow-down-circle': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13l3 3m0 0l3-3m-3 3V8m0 13a9 9 0 110-18 9 9 0 010 18z"/></svg>',
      'pencil': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>',
      'calendar-day': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>',
      'calendar-range': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>',
      'exclamation-triangle': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>',
      'heart-pulse': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>',
      'share-2': '<svg class="' + className + '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z"/></svg>',
